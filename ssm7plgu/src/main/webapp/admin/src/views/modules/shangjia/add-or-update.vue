          ...
          <el-form-item class="input" label="商家名称" prop="shangjiamingcheng">
              <el-input v-model="ruleForm.shangjiamingcheng" 
                placeholder="商家名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家类型" prop="shangjialeixing">
          <el-input v-model="ruleForm.shangjialeixing" 
              placeholder="商家类型" clearable  :readonly="ro.shangjialeixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家类型" prop="shangjialeixing">
              <el-input v-model="ruleForm.shangjialeixing" 
          ...
          <el-form-item class="input" label="商家地址" prop="shangjiadizhi">
              <el-input v-model="ruleForm.shangjiadizhi" 
                placeholder="商家地址" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="商家介绍" prop="shangjiajieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangjiajieshao" label="商家介绍" prop="shangjiajieshao">
                    <span>{{ruleForm.shangjiajieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangjiamingcheng = true;
            ...
            this.ruleForm.shangjialeixing = obj[o];
	    this.ro.shangjialeixing = true;
            continue;
          }
	            	            if(o=='shangjiatupian'){
