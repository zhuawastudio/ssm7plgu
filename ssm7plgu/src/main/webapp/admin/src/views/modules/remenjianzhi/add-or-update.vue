<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兼职名称" prop="jianzhimingcheng">
          <el-input v-model="ruleForm.jianzhimingcheng" 
              placeholder="兼职名称" clearable  :readonly="ro.jianzhimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兼职名称" prop="jianzhimingcheng">
              <el-input v-model="ruleForm.jianzhimingcheng" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总薪资" prop="zongxinzi">
          <el-input v-model="ruleForm.zongxinzi" 
              placeholder="总薪资" clearable  :readonly="ro.zongxinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总薪资" prop="zongxinzi">
              <el-input v-model="ruleForm.zongxinzi" 
                placeholder="总薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="长短期" prop="zhangduanqi">
          <el-select v-model="ruleForm.zhangduanqi" placeholder="请选择长短期">
            <el-option
                v-for="(item,index) in zhangduanqiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="长短期" prop="zhangduanqi">
	      <el-input v-model="ruleForm.zhangduanqi"
                placeholder="长短期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="工作时长" prop="gongzuoshizhang">
              <el-input v-model="ruleForm.gongzuoshizhang" 
                placeholder="工作时长" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兼职要求" prop="jianzhiyaoqiu">
          <el-input v-model="ruleForm.jianzhiyaoqiu" 
              placeholder="兼职要求" clearable  :readonly="ro.jianzhiyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兼职要求" prop="jianzhiyaoqiu">
              <el-input v-model="ruleForm.jianzhiyaoqiu" 
                placeholder="兼职要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="兼职介绍" prop="jianzhijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianzhijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianzhijieshao" label="兼职介绍" prop="jianzhijieshao">
                    <span v-html="ruleForm.jianzhijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	clicknum : false,
            ...
            ruleForm: {
                  ...
                  zongxinzi: [
                            { required: true, message: '总薪资不能为空', trigger: 'blur' },
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='zongxinzi'){
            this.ruleForm.zongxinzi = obj[o];
	    this.ro.zongxinzi = true;
            continue;
          }
	            	            if(o=='zhangduanqi'){
            this.ruleForm.zhangduanqi = obj[o];
	    this.ro.zhangduanqi = true;
            continue;
          }
	            	            if(o=='gongzuodidian'){
	    ...
	    this.ro.gongzuoshizhang = true;
            continue;
	            	            ...
	            	            if(o=='jianzhiyaoqiu'){
            this.ruleForm.jianzhiyaoqiu = obj[o];
	    this.ro.jianzhiyaoqiu = true;
            continue;
          }
	            	            if(o=='jianzhijieshao'){
            this.ruleForm.jianzhijieshao = obj[o];
	    this.ro.jianzhijieshao = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `remenjianzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.remenjianzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
