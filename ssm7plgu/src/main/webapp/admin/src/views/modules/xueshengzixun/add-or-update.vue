<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询标题" prop="zixunbiaoti">
          <el-input v-model="ruleForm.zixunbiaoti" 
              placeholder="咨询标题" clearable  :readonly="ro.zixunbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询标题" prop="zixunbiaoti">
              <el-input v-model="ruleForm.zixunbiaoti" 
                placeholder="咨询标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
