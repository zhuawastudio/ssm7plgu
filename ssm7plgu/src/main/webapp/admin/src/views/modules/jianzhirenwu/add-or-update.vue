      ...
      <el-row>
          ...
          <el-form-item class="input" label="总薪资" prop="zongxinzi">
              <el-input v-model="ruleForm.zongxinzi" 
                placeholder="总薪资" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="任务附件" prop="renwufujian">
          <file-upload
          tip="点击上传任务附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.renwufujian" label="任务附件" prop="renwufujian">
            <el-button type="text" size="small" @click="download(ruleForm.renwufujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianzhirenwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianzhirenwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
