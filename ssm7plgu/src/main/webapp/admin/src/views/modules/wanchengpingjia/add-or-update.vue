          ...
          <el-form-item class="input" v-if="ruleForm.wanchengshijian" label="完成时间" prop="wanchengshijian">
              <el-input v-model="ruleForm.wanchengshijian" 
                placeholder="完成时间" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="附件信息" prop="fujianxinxi">
          <file-upload
          tip="点击上传附件信息"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.fujianxinxi?ruleForm.fujianxinxi:''"
          @change="fujianxinxiUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.fujianxinxi" label="附件信息" prop="fujianxinxi">
            <el-button type="text" size="small" @click="download(ruleForm.fujianxinxi)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                                                <el-col :span="12">
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="兼职评价" prop="jianzhipingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="兼职评价"
                  v-model="ruleForm.jianzhipingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianzhipingjia" label="兼职评价" prop="jianzhipingjia">
                    <span>{{ruleForm.jianzhipingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  jianzhipingjia: [
                            { required: true, message: '兼职评价不能为空', trigger: 'blur' },
                                    	                                                              ],
                  neirongxiangqing: [
                                    	                                                              ],
                  xuehao: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wanchengshijian = true;
            continue;
	            	            ...
	            	            if(o=='fujianxinxi'){
            this.ruleForm.fujianxinxi = obj[o];
	    this.ro.fujianxinxi = true;
            continue;
          }
	            	            if(o=='jianzhipingjia'){
            this.ruleForm.jianzhipingjia = obj[o];
	    this.ro.jianzhipingjia = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wanchengpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wanchengpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                ...
                                                                                                fujianxinxiUploadChange(fileUrls) {
                this.ruleForm.fujianxinxi = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
