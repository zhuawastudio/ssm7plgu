  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">校园兼职平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="商家名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiamingcheng" autocomplete="off" placeholder="商家名称" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shangjialeixing" class="input" type="text" placeholder="商家类型">
			   </div>
			 </div> -->
			<el-form-item label="商家类型" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjialeixing" autocomplete="off" placeholder="商家类型" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='shangjia'" class="input-group">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.shangjialeixing) && `shangjia` == this.tableName){
